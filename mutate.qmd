---
title: "Creating New Columns Using `mutate()`"
author: "Thomas"
format: html
editor: visual
---
...
The final condition `TRUE` is the is a catch all term and must be used with some caution. Consider what happens when we set the `AGE` of the first subject to `NA`.
