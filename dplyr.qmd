...
```{r}
# base
adsl[c("STUDYID", "USUBJID","ARM", "AGE", "SEX", "RACE")]

# dplyr::select
adsl_select <- select(.data = adsl, STUDYID, USUBJID, ARM, AGE, SEX, RACE)
...
We can use the `select()` function to reorder the variables in the data-frame. 
This does not affect the order of rows.
