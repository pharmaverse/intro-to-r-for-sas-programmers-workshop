...
However, the nested call is not very intuitive to read.
If any more functions get added to this code, it becomes even less readable. 
That is where the pipe operator (` %>% `) comes in.
...
The pipe operator let's us write nested function calls in a sequential way.
